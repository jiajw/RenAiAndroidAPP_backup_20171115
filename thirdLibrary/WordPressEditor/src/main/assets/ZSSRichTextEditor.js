...
ZSSEditor.refreshVisibleViewportSize = function () {
    document.log("refreshVisibleViewportSize");
...
ZSSEditor.execFunctionForResult = function (methodName) {
    ...
    console.log("ZSSEditor.execFunctionForResult");
...
ZSSEditor.trackNodeForMutation = function (target) {
    ...
    console.log("ZSSEditor.trackNodeForMutation");
    ...
    if (ZSSEditor.mutationObserver != undefined) {
        ...
        target.bind("DOMNodeRemoved", function (event) {
...
ZSSEditor.onMutationObserved = function (mutations) {
    ...
    console.log("ZSSEditor.onMutationObserved");
...
ZSSEditor.onDomNodeRemoved = function (event) {
    console.log("ZSSEditor.onDomNodeRemoved");
...
ZSSEditor.selectionChangedCallback = function () {
    ...
    console.log("ZSSEditor.selectionChangedCallback");
...
ZSSEditor.callback = function (callbackScheme, callbackPath) {
    ...
    console.log("ZSSEditor.callback ");
...
ZSSEditor.callbackThroughIFrame = function (url) {
    console.log("ZSSEditor.callbackThroughIFrame");
...
ZSSEditor.stylesCallback = function (stylesArray) {
    ...
    console.log("ZSSEditor.stylesCallback");
    var stylesString = '';
...
ZSSEditor.backupRange = function () {
    console.log("ZSSEditor.backupRange");
    var selection = window.getSelection();
...
ZSSEditor.restoreRange = function () {
    console.log("ZSSEditor.restoreRange ");
...
ZSSEditor.resetSelectionOnField = function (fieldId, offset) {
    console.log("ZSSEditor.resetSelectionOnField");
...
ZSSEditor.giveFocusToElement = function (element, offset) {
    console.log("ZSSEditor.giveFocusToElement ");
...
ZSSEditor.setFocusAfterElement = function (element) {
    console.log("ZSSEditor.setFocusAfterElement");
    var selection = window.getSelection();
...
ZSSEditor.getSelectedText = function () {
    console.log("ZSSEditor.getSelectedText");
    var selection = window.getSelection();
    return selection.toString();
};

ZSSEditor.selectWordAroundCursor = function () {
    console.log("ZSSEditor.selectWordAroundCursor");
...
ZSSEditor.canExpandForward = function (range) {
    ...
    console.log("ZSSEditor.canExpandForward ");
...
ZSSEditor.getSelectedTextToLinkify = function () {
    ...
    console.log("ZSSEditor.getSelectedTextToLinkify");
...
ZSSEditor.getCaretArguments = function () {
    ...
    console.log("ZSSEditor.getCaretArguments");
...
ZSSEditor.getJoinedFocusedFieldIdAndCaretArguments = function () {
    ...
    console.log("ZSSEditor.getJoinedFocusedFieldIdAndCaretArguments");
...
ZSSEditor.getJoinedCaretArguments = function () {
    ...
    console.log("ZSSEditor.getJoinedCaretArguments");
...
ZSSEditor.getCaretYPosition = function () {
    ...
    console.log("ZSSEditor.getCaretYPosition");
...
ZSSEditor.getYCaretInfo = function () {
    ...
    console.log("ZSSEditor.getYCaretInfo");
...
/*设置字体大小*/
ZSSEditor.setFontSize = function (fontsize) {
...
ZSSEditor.setItalic = function () {
    ...
    console.log("ZSSEditor.setItalic");
...
ZSSEditor.setSubscript = function () {
    ...
    console.log("ZSSEditor.setSubscript");
...
ZSSEditor.setSuperscript = function () {
    ...
    console.log("ZSSEditor.setSuperscript");
...
ZSSEditor.setStrikeThrough = function () {
    ...
    console.log("ZSSEditor.setStrikeThrough");
...
ZSSEditor.setUnderline = function () {
    ...
    console.log("ZSSEditor.setUnderline");
...
ZSSEditor.setBlockquote = function () {
    ...
    console.log("ZSSEditor.setBlockquote");
...
ZSSEditor.removeFormating = function () {
    ...
    console.log("ZSSEditor.removeFormating ");
...
ZSSEditor.setHorizontalRule = function () {
    ...
    console.log("ZSSEditor.setHorizontalRule");
...
ZSSEditor.setHeading = function (heading) {
    ...
    console.log("ZSSEditor.setHeading ");
...
ZSSEditor.setParagraph = function () {
    ...
    console.log("ZSSEditor.setParagraph");
...
ZSSEditor.setOrderedList = function () {
    ...
    console.log("ZSSEditor.setOrderedList");
...
ZSSEditor.setUnorderedList = function () {
    ...
    console.log("ZSSEditor.setUnorderedList");
...
ZSSEditor.setJustifyCenter = function () {
    ...
    console.log("ZSSEditor.setJustifyCenter");
...
ZSSEditor.setJustifyFull = function () {
    ...
    console.log("ZSSEditor.setJustifyFull");
...
ZSSEditor.setJustifyLeft = function () {
    ...
    console.log("ZSSEditor.setJustifyLeft");
...
ZSSEditor.setJustifyRight = function () {
    ...
    console.log("ZSSEditor.setJustifyRight");
...
ZSSEditor.setIndent = function () {
    ...
    console.log("ZSSEditor.setIndent ");
...
ZSSEditor.setOutdent = function () {
    ...
    console.log("ZSSEditor.setOutdent");
...
/*
设置字体颜色
注意颜色是十六机制的六位字符比如：#FF0000
不可以在前面带有透明度 比如：#FFFF0000

*/
ZSSEditor.setFontColor = function (color) {

    console.log("ZSSEditor.setFontColor ");
...
ZSSEditor.setBackgroundColor = function (color) {
    ...
    console.log("ZSSEditor.setBackgroundColor");
...
ZSSEditor.insertHTMLWrappedInParagraphTags = function (html) {
    ...
    console.log("ZSSEditor.insertHTMLWrappedInParagraphTags");
...
ZSSEditor.insertLink = function (url, title) {
    ...
    console.log("ZSSEditor.insertLink");
...
ZSSEditor.updateLink = function (url, title) {
    ...
    console.log("ZSSEditor.updateLink");
...
ZSSEditor.quickLink = function () {
    ...
    console.log("ZSSEditor.quickLink");
...
ZSSEditor.toggleBlockquoteForSpecificChildNodes = function (parentNode, nodes) {
    ...
    console.log("ZSSEditor.toggleBlockquoteForSpecificChildNodes ");
...
ZSSEditor.turnBlockquoteOffForNode = function (node) {
    ...
    console.log("ZSSEditor.turnBlockquoteOffForNode ");
...
ZSSEditor.turnBlockquoteOnForNode = function (node) {
    ...
    console.log("ZSSEditor.turnBlockquoteOnForNode");
...
ZSSEditor.isMediaContainerNode = function (node) {
    ...
    console.log("ZSSEditor.isMediaContainerNode");
...
ZSSEditor.extractMediaIdentifier = function (node) {
    ...
    console.log("ZSSEditor.extractMediaIdentifier");
...
ZSSEditor.getMediaNodeWithIdentifier = function (mediaNodeIdentifier) {
    ...
    console.log("ZSSEditor.getMediaNodeWithIdentifier");
...
ZSSEditor.getMediaProgressNodeWithIdentifier = function (mediaNodeIdentifier) {
    ...
    console.log("ZSSEditor.getMediaProgressNodeWithIdentifier");
...
ZSSEditor.getMediaContainerNodeWithIdentifier = function (mediaNodeIdentifier) {
    ...
    console.log("ZSSEditor.getMediaContainerNodeWithIdentifier");
...
ZSSEditor.setProgressOnMedia = function (mediaNodeIdentifier, progress) {
    ...
    console.log("ZSSEditor.setProgressOnMedia");
...
ZSSEditor.setupOptimisticProgressUpdate = function (mediaNodeIdentifier, nCall) {
    ...
    console.log("ZSSEditor.setupOptimisticProgressUpdate");
...
ZSSEditor.sendOptimisticProgressUpdate = function (mediaNodeIdentifier, nCall) {
    ...
    console.log("ZSSEditor.sendOptimisticProgressUpdate");
...
ZSSEditor.removeMedia = function (mediaNodeIdentifier) {
    ...
    console.log("ZSSEditor.removeMedia");
...
ZSSEditor.sendMediaRemovedCallback = function (mediaNodeIdentifier) {
    ...
    console.log("ZSSEditor.sendMediaRemovedCallback");
...
ZSSEditor.markAllUploadingMediaAsFailed = function (message) {
    ...
    console.log("ZSSEditor.markAllUploadingMediaAsFailed");
...
ZSSEditor.getFailedMediaIdArray = function () {
    ...
    console.log("ZSSEditor.getFailedMediaIdArray");
...
ZSSEditor.getFailedMedia = function () {
    ...
    Console.log("ZSSEditor.getFailedMedia");
...
ZSSEditor.updateImage = function (url, alt) {
    Console.log("ZSSEditor.updateImage");
...
ZSSEditor.insertImage = function (url, remoteId, alt) {
    ...
    Console.log("ZSSEditor.insertImage");
...
ZSSEditor.markImageUploadDone = function (imageNodeIdentifier) {
    ...
    var thisObj = this;
    setTimeout(function () {
        thisObj.sendImageReplacedCallback(imageNodeIdentifier);
    }, 500);
};
...
/**
 * todo 插入图片
 * 操作一： 删除了 <span class="edit-content">' + nativeState.localizedStringEdit + '</span>
 * 格式化图片标签 <img>
 * @param imageNode
 * @returns {*|Node}
 */
...
ZSSEditor.storeInlineStylesAsFunctions = function () {
    ...
    console.log("ZSSEditor.storeInlineStylesAsFunctions ");
    var styles = [];
...
ZSSField.prototype.bindListeners = function () {
    ...
    this.wrappedObject.on('paste', function (e) {
...
ZSSField.prototype.handleKeyDownEvent = function (e) {
    ...
    document.log("handleKeyDownEvent" + e.keyCode);
 ...
 * @param elemId
 */
ZSSEditor.setCaretPosition = function (elemId){
