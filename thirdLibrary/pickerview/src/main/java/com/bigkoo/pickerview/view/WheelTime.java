...
public class WheelTime {
    ...
    public void setPicker(int year, final int month, int day, int h, int m, int second) {
      ...
      /*  wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字*/
       ...
       /* wv_mins.setLabel(context.getString(R.string.pickerview_minutes));// 添加文字*/
        ...
        if (second != -1) {
            ...
            wv_seconds.setCurrentItem(second);
    ...
    public void setPicker(int year, final int month, int day, int h, int m) {
        setPicker(year, month, day, h, m, -1);
    }
    ...
    public void setLabels(String label_year, String label_month, String label_day, String label_hours, String label_mins) {
        if (label_year != null) {
