...
import com.yousails.chrenai.person.ui.PaymentDetailsActiviity;
...
public class PaymentManageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public PaymentManageAdapter(Context context, List<RegisterInforBean> registerInforList){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (mHeaderView == null) {
            if (viewType == TYPE_NORMAL) {
                View view = LayoutInflater.from(mContext).inflate(R.layout.payment_manage_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        if (getItemViewType(position) == TYPE_HEADER) {
            ...
            ((CustomHolder) viewHolder).paymentView.setText("缴费:"+getPayments(registerInforBean.getPay_amount())+"元");
            ((CustomHolder) viewHolder).refundmentView.setText("退款:"+getPayments(registerInforBean.getRefund_amount())+"元");
            ...
            ((CustomHolder) viewHolder).addPaymentView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    if(onPaymentListener!=null){
                        onPaymentListener.onPayment(registerInforBean,"pay");
                    }
                }
            });


            ((CustomHolder) viewHolder).addRefundment.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    if(onPaymentListener!=null){
                        onPaymentListener.onPayment(registerInforBean,"refund");
                    }
                }
            });
            ...
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(mContext, PaymentDetailsActiviity.class);
    ...
    class CustomHolder extends RecyclerView.ViewHolder {
        ...
        private TextView refundmentView;
        private TextView  addPaymentView;
        private TextView addRefundment;
        ...
        public CustomHolder(View view) {
            ...
            paymentView= (TextView) view.findViewById(R.id.payment_tview);
            refundmentView= (TextView) view.findViewById(R.id.refundment_tview);
            addPaymentView= (TextView) view.findViewById(R.id.add_payment_tview);
            addRefundment= (TextView) view.findViewById(R.id.add_refundment_tview);
    ...
    public void setOnItemClickListener(OnPaymentListener onPaymentListener) {
