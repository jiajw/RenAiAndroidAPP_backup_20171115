...
public class DateUtil {
    ...
    public static String getDateM(String date) {
        return StringToString(date, DateStyle.MM_DD);
    }
...
//		long time = Math.abs(date.getTime() - otherDate.getTime());
    ...
    public static int getIntervalHours(String date, String otherDate) {
        return getIntervalHours(StrToDate(date), StrToDate(otherDate));
    }
    ...
    public static int getDateDiff(Date date, Date otherDate, int sign) {
        ...
        return Math.abs((int) ((date.getTime() - otherDate.getTime()) / base));
    }

    public static int getDateDiff(String date, String otherDate, int sign) {

        return getDateDiff(StringToDate(date), StringToDate(otherDate), sign);
    }
    ...
    public static String removeExtraChar(String time) {
    ...
    public static boolean calHour(String date1, String date2) {
